...
class ToDoList extends React.Component {
    ...
    openModalInput = () => {
        this.props.dispatch({
            type: 'TO_DO_LIST/OPEN_MODAL_INPUT',
            payload: {
                modalTaskInput: true,
            },
        });
    ...
    makeTaskDone = (event) => {
        ...
        this.props.dispatch({
            type: 'TO_DO_LIST/MAKE_TASK_DONE',
            payload: {
                list: newList,
            },
        });
